...
while in phase 2 we simply want to return the token names to Bison.

FOR PHASE 2:
- The first test, test_phase2a.la, has been created by me, simply to test everything that I have implemented (basic types, variable declaration,
assignments, arithmetic, comparisons, Booleans, function definition and calling, main function, returns, if-while-for loops with all the variations such as else, break, continue)
...
To compile and run files for phase 2, you can add these to the script phase2.sh.
